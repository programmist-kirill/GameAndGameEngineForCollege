...
class Render_scene3:
    def Render_scene():
        with open("/home/kirill/game_engine_new/Cache/half_scene_for_render" , "r") as file:
            half_scene = file.read()
    ...
    def Assembling_the_initial_scene():
        with open("/home/kirill/game_engine_new/Cache/action" , "w") as fp:
            fp.write("draw_obstacle")

        os.system("python /home/kirill/game_engine_new/Data/scene3.dll")

        with open("/home/kirill/game_engine_new/Cache/half_scene_for_render" , "r") as file:
            half_render = file.read()
...
class Render_game_college:
    
    def Render_scene(scene):
        
        with open("/home/kirill/NOT_DELETE_FOLDER/game_for_college/Data/sky.asset" , "r") as file:
            sky = file.read().strip()
